...
<template>
  <MainLayout>
    ...
    <article class="px-8 py-16 max-w-4xl mx-auto text-gray-800">
      <section>
        <h2 class="text-2xl font-semibold text-gray-900">Lorem ipsum dolor sit amet</h2>
        <p class="mt-4 text-base text-neutral-600 leading-7">
      ...
      <section class="mt-8">
        <h2 class="text-2xl font-semibold text-gray-900">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</h2>
        <p class="mt-4 text-base text-neutral-600 leading-7">
